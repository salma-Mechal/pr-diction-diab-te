...
with tab1:
    ...
    if st.button("📌 Prédire"):
        ...
        try:
            ...
            st.error("Le modèle n'est pas encore ajusté. Veuillez vérifier le modèle.")
        ...
        try:
            ...
            if df is not None:
                ...
                if missing_cols:
                    ...
                    # Compléter les colonnes manquantes par des valeurs par défaut (par exemple, 0 ou NaN)
